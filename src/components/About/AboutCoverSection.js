...
const AboutCoverSection = () => {
  return (
    <section className='w-full md:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex flex-col md:flex-row items-center justify-center text-dark dark:text-light'>
      ...
      <div className='w-full md:w-1/2 flex flex-col text-left items-start justify-center px-5 xs:p-10 pb-10 lg:px-16'>
        <h2 className='font-bold capitalize text-4xl xs:text-5xl sxl:text-6xl text-center lg:text-left'>
          Kaisar Titoniran Akbar, S.Pd.
        </h2>
        <p className='font-medium mt-4 text-base'>
          Saya seorang guru matematika di SMAN 1 Tanjung yang  bersemangat  mengenai  pembelajaran  berbasis  TIK.  Saya  meyakini  bahwa  teknologi  dapat  menjadi  alat  yang  ampuh  untuk  menciptakan  pembelajaran  matematika  yang  lebih  menarik,  bermakna,  dan  sesuai  dengan  kebutuhan  siswa.  Melalui  blog  ini,  saya  berbagi  pengalaman  dan  pembelajaran  saya  dalam  menerapkan  TIK,  khususnya  dalam  konteks  Kurikulum  Merdeka. 
        </p>
      </div>
    </section>
  )
